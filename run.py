...
def main():
    ...
    parser.add_argument('--DataDivision', action='store_true')
    parser.add_argument('--training', action='store_true')
    parser.add_argument('--tracking_demo', action='store_true')
    parser.add_argument('--tracking_operation', action='store_true')
